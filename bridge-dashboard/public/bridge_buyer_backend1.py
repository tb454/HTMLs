# FastAPI backend for BRidge Buyer Portal - Production Grade
...
class BOLRecord(BaseModel):
    ...
    status: str  # Open, Matched, BOL Issued, In Transit, Delivered, Closed

# --- In-memory store (temporary for build phase) ---
