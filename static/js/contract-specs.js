...
/*********************************************************
 * 2) Pricing Functions (same as your original)
 *********************************************************/
...
// (c) Build HTML for a single material's spec sheet
    ...
    <details id="${materialName.replace(/\s+/g, "_")}-futures-specs">
      ...
      <div class="spec-content">
        ...
        <ul>
          ...
          <li><strong>Reference Model Price:</strong> ${displayPrice} USD/lb (internal model)</li>
          <li>
            <strong>Trading Hours:</strong>
            <ul>
              <li><em>BRidge:</em> Sunday - Friday 6:00 p.m. - 3:00 p.m. (7:00 p.m. - 4:00 p.m. CT)</li>
            </ul>
          </li>
...
// Run on DOM ready (since script is loaded with defer, DOM is ready here)
document.addEventListener("DOMContentLoaded", generateAllSpecSheets);
